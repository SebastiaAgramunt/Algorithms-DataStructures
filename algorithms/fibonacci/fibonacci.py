...
if __name__ == '__main__':
	...
	print("the {}th fibonacci number is {}, calculated using forward fibonacci O(N). Time elapsed {}".format(n, f, end-start))
	...
	print("the {}th fibonacci number is {}, calculated using powr matrix optimized O(log(N)), taken from GeeksToGeeks webpage. Time elapsed {}".format(n, f, end-start))
